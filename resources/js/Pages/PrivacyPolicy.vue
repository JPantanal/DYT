            ...
            <section class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>Purpose: These Cookies are used to track information about traffic to the Website and how
                ...
                <ul>
                    ...
                    <li><strong>Public interests:</strong> Processing Personal Data is related to a task that is carried
                        out in the public interest or in the exercise of official authority vested in the Company.</li>
                    <li><strong>Legitimate interests:</strong> Processing Personal Data is necessary for the purposes of
                        the legitimate interests pursued by the Company.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li><strong>Request correction of the Personal Data that We hold about You.</strong> You have the
                        right to have any incomplete or inaccurate information We hold about You corrected.</li>
                    ...
                    <li><strong>Request erasure of Your Personal Data.</strong> You have the right to ask Us to delete
                        or remove Personal Data when there is no good reason for Us to continue processing it.</li>
                    ...
                    <li><strong>Withdraw Your consent.</strong> You have the right to withdraw Your consent on using
                        ...
                        to certain specific functionalities of the Service.</li>
                </ul>
                ...
                <p>We may let You know via email and/or a prominent notice on Our Service, prior to the change becoming
