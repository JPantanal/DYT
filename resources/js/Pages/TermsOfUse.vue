...
<template>
    <guest-layout>
        <div class="max-w-7xl p-6 lg:p-8 mx-auto px-4 py-8 ">
            <h1 class="mb-8 text-3xl font-bold text-center"> Terms of Use </h1>
            <section class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <h2 class="text-2xl font-bold mb-4">Introduction</h2>
                <p class="mb-4">These Terms of Use govern your use of our website located at DaytonTutoring.com and form
                    a binding contractual agreement between you, the user of the site, and us, DaytonTutoring LLC.</p>
                ...
                <p><strong>Please read these terms of use ("terms of use", "agreement") carefully before using
                        DaytonTutoring.com
                        website (“website”, "service") operated by DaytonTutoring ("us", 'we", "our").
                        Conditions of use
                    </strong></p>
                <p><strong>Our Privacy Policy was last updated on 12/12/2023.</strong></p>
                <p>By using this website, you certify that you have read and reviewed this Agreement and that you
                    ...
                    you are advised to leave the website accordingly. DaytonTutoring only grants use and access of this
                ...
                <p>
                    ...
                    Agreement. DaytonTutoring assumes no responsibility for liabilities related to age
                    misrepresentation.
                    Intellectual property
                </p>
                <p>
                    You agree that all materials, products, and services provided on this website are the property of
                    DaytonTutoring, its affiliates, directors, officers, employees, agents, suppliers, or licensors
                    including all
                    copyrights, trade secrets, trademarks, patents, and other intellectual property. You also agree
                    that you will not reproduce or redistribute the DaytonTutoring’s intellectual property in any way,
                    including electronic, digital, or new trademark registrations.
                </p>
                <p>
                    You grant DaytonTutoring a royalty-free and non-exclusive license to display, use, copy, transmit,
                    and
                ...
                <p>
                    By visiting this website, you agree that the laws in your jurisdiction, without regard to principles
                    of
                    conflict laws, will govern these terms and conditions, or any dispute of any sort that might come
                    between DaytonTutoring and you, or its business partners and associates.
                </p>
                ...
                <p>
                    You agree to indemnify DaytonTutoring and its affiliates and hold DaytonTutoring harmless against
                    legal claims
                ...
                <p>
                    DaytonTutoring is not liable for any damages that may occur to you as a result of your misuse of our
                    website.
                </p>
                <p>
                    DaytonTutoring reserves the right to edit, modify, and change this Agreement any time. This
                    Agreement is an understanding
                    between DaytonTutoring and the user, and this supersedes and replaces all prior agreements regarding
